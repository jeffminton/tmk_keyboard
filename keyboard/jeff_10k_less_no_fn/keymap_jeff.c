...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ,-------------------------------------------------------------------------------.
     * |Esc|  1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  =|Backsp |Insert |Home |PgUp |
     * |-------------------------------------------------------------------------------|
     * |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|    \|Del    |End  |PgDn |
     * |-------------------------------------------------------------------------------|
     * |Caps  |  A|  S|  D|  F|  G|  H|  J|  K|  L|Fn2|  '|Return  |                   |
     * |-------------------------------------------------------------------------------|
     * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|Fn1|Shift     |       |Up   |     |
     * |-------------------------------------------------------------------------------|
     * |Ctrl|Gui |Alt |      Space             |Alt |Fn0 |App |Ctrl|Left   |Down |Rght |
     * `-------------------------------------------------------------------------------`
     */
    KEYMAP_ANSI(
        FN8, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSPC, INS, HOME, PGUP, \
        TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,BSLS, DEL, END,  PGDN, \
        LGUI,A,   S,   D,   F,   G,   H,   J,   K,   L,   FN2, QUOT,     ENT,  \
        LSFT,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, FN1,           RSFT,      UP,  \
    ...
    KEYMAP_ANSI(
        GRV, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSPC, INS, HOME, PGUP, \
        TAB, Q,   D,   R,   W,   B,   J,   F,   U,   P,   SCLN,LBRC,RBRC,BSLS, DEL, END, PGDN, \
     ...
     * |-----------------------------------------------------------|
     * |Ctrl|Gui |Alt |      Space             |Alt |   |App |    |
     * `-----------------------------------------------------------'
     */
    KEYMAP_ANSI(
        GRV, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, DEL, PSCR, SLCK, PAUS,  \
        TAB,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,PSCR,SLCK,PAUS,UP,  TRNS,INS, DEL, END, PGDN,  \
        CAPS,VOLD,VOLU,MUTE,TRNS,TRNS,PAST,PSLS,HOME,PGUP,LEFT,RGHT,     ENT,  \
        LSFT,TRNS,TRNS,TRNS,TRNS,TRNS,PPLS,PMNS,END, PGDN,DOWN,          RSFT, UP, \
        LCTL,LGUI,LALT,     SPC,                     RALT,TRNS,FN3,      TRNS,LEFT, DOWN, RGHT),
    ...
    KEYMAP_ANSI(
        ...
        TAB, HOME,PGDN,UP,  PGUP,END, HOME,PGDN,PGUP,END, TRNS,TRNS,TRNS,TRNS, DEL, END, PGDN, \
        LCTL,TRNS,LEFT,DOWN,RGHT,TRNS,LEFT,DOWN,UP,  RGHT,TRNS,TRNS,     ENT,  \
        LSFT,TRNS,TRNS,TRNS,TRNS,TRNS,HOME,PGDN,PGUP,END, TRNS,          RSFT, UP, \
    ...
    */
     ...
     */
    KEYMAP_ANSI(
        FN4, FN5, FN6, FN7, FN9,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, TRNS, TRNS, TRNS, \
	...
	/* Keymap 4: wasd to arrow */
    KEYMAP_ANSI(
        FN8, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSPC, INS, HOME, PGUP, \
        TAB, Q,   UP,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,BSLS, DEL, END,  PGDN, \
        LCTL,LEFT,DOWN,RGHT,   F,   G,   H,   J,   K,   L,   SCLN, QUOT,     ENT,  \
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [9] = ACTION_DEFAULT_LAYER_SET(8),  // set wasd to arrow
};
