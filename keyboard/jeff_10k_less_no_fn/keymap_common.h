...
#define KEYMAP( \
    ...
    K40, K41, K42,      K44,                     K49, K4A, K4B, K4C, K4D, K4E, K4F, K4G  \
) { \
    ...
    { KC_##K40, KC_##K41, KC_##K42, KC_NO,    KC_##K44, KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_##K49, KC_##K4A, KC_##K4B, KC_##K4C, KC_##K4D, KC_##K4E, KC_##K4F, KC_##K4G }  \
}
...
#define KEYMAP_ANSI( \
    ...
    K30, K31, K32, K33, K34, K35, K36, K37, K38, K39, K3A,           K3D,      K3F,     \
    K40, K41, K42,      K44,                     K49, K4A, K4B,      K4D, K4E, K4F, K4G \
) KEYMAP( \
    K00, K01, K02, K03, K04, K05, K06, K07, K08, K09, K0A, K0B, K0C, K0D, K0E, K0F, K0G, \
    K10, K11, K12, K13, K14, K15, K16, K17, K18, K19, K1A, K1B, K1C, K1D, K1E, K1F, K1G, \
    K20, K21, K22, K23, K24, K25, K26, K27, K28, K29, K2A, K2B, NO,  K2D, NO,  NO,  NO,  \
    K30, K31, K32, K33, K34, K35, K36, K37, K38, K39, K3A, NO,  NO,  K3D, NO,  K3F, NO,  \
    K40, K41, K42,      K44,                     K49, K4A, K4B, NO,  K4D, K4E, K4F, K4G \
)
